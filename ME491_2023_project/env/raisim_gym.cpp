...
PYBIND11_MODULE(RAISIMGYM_TORCH_ENV_NAME, m) {
  py::class_<VectorizedEnvironment<ENVIRONMENT>>(m, RSG_MAKE_STR(ENVIRONMENT_NAME))
      ...
      .def("observe_blue", &VectorizedEnvironment<ENVIRONMENT>::observe_blue)
      ...
      .def("getObDim_blue", &VectorizedEnvironment<ENVIRONMENT>::getObDim_blue)
      .def("getActionDim_blue", &VectorizedEnvironment<ENVIRONMENT>::getActionDim_blue)
